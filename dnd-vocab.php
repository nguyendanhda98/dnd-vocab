...
function dnd_vocab_init() {
	...
	require_once DND_VOCAB_PLUGIN_DIR . 'includes/shortcodes.php';
    require_once DND_VOCAB_PLUGIN_DIR . 'includes/fsrs-plusplus.php';
    require_once DND_VOCAB_PLUGIN_DIR . 'includes/fsrs-test-page.php';
}
